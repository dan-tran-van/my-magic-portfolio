...
const social: Social = [
  ...
  // Set essentials: true for links you want to show on the about page
  {
    name: "GitHub",
    icon: "github",
    link: "https://github.com/dan-tran-van",
    essential: true,
  },
  {
    name: "LinkedIn",
    icon: "linkedin",
    link: "https://www.linkedin.com/in/dan-tran-van/",
    essential: true,
  },
  {
    name: "Instagram",
    icon: "instagram",
    link: "https://www.instagram.com/susanoo.no.mikoto.86/",
    essential: false,
  },
  {
    name: "Threads",
    icon: "threads",
    link: "https://www.threads.com/@susanoo.no.mikoto.86",
    essential: true,
  },
  {
    name: "Email",
...
const home: Home = {
  ...
  headline: <>Building language aware websites</>,
  featured: {
    display: true,
    title: (
      <Row gap="12" vertical="center">
        <strong className="ml-4">Torangu</strong>{" "}
    ...
    href: "/work/building-torangu-a-social-media-supports-vertical-languages",
  },
  subline: (
    <>
      I'm Dan, a Full Stack Developer at{" "}
      <Text as="span" size="xl" weight="strong">
        Du gian Private Enterprise
      </Text>
